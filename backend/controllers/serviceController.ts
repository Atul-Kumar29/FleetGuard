...
exports.getServiceQueue = async (req: Request, res: Response) => {
    try {
        const {
            search = "",
            status = "all",
            sort = "due_date"
        } = req.query as { search?: string; status?: string; sort?: string };
        ...
        let serviceQueue: any[] = (vehicles || []).map((vehicle: any) => {
        ...
        if (search.trim()) {
            ...
            serviceQueue = serviceQueue.filter((vehicle: any) =>
...
exports.getServiceTypes = async (req: Request, res: Response) => {
    try {
 ...
 */
exports.startService = async (req: Request, res: Response) => {
    try {
        const { vehicleId }: { vehicleId?: string } = req.body;
...
exports.completeService = async (req: Request, res: Response) => {
    try {
        const {
            vehicleId,
            serviceTypeId,
            ...
            nextServiceKm?: number | string | null;
        } = req.body;
...
exports.getServiceHistory = async (req: Request, res: Response) => {
    try {
        ...
        const serviceHistory: any[] = (services || []).map((item: any) => {
            return {
                id: item.id,
