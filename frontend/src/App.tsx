...
function AppContent() {
  ...
  const [selectedServiceVehicle, setSelectedServiceVehicle] = useState<{ id: string | null; name: string }>({ id: null, name: '' });
  ...
  const handleViewServiceHistory = (vehicleId: string, vehicleName: string) => {
