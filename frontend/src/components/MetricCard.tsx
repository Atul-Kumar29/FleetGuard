 ...
 */
type MetricCardProps = { title: string; value: number | string; icon?: React.ReactNode; color?: string };

export default function MetricCard({ title, value, icon, color = 'sky' }: MetricCardProps) {
