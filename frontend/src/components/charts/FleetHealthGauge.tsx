 ...
 */
type FleetHealthGaugeProps = { metrics?: Record<string, number | undefined> };

export default function FleetHealthGauge({ metrics }: FleetHealthGaugeProps) {
  ...
  const radialBarProps: any = { background: { fill: '#f1f5f9' }, clockWise: true };
