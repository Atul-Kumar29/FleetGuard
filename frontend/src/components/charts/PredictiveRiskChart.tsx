 ...
 */
type PredictiveRiskChartProps = { predictiveData?: Array<Record<string, unknown>> };

export default function PredictiveRiskChart({ predictiveData }: PredictiveRiskChartProps) {
