 ...
 */
type SummaryCardProps = { title: string; value: number | string; icon?: React.ReactNode; variant?: string };

export default function SummaryCard({ title, value, icon, variant = 'primary' }: SummaryCardProps) {
