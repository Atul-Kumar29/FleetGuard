...
function getStatusClasses(status: any) {
  switch (status) {
    case 'ACTIVE':
...
export default function FleetListPage({ onSelectVehicle }: any) {
  ...
  const [targetVehicleForAssignment, setTargetVehicleForAssignment] = useState<any>(null);
